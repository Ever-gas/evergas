    ...
    return (
        ...
        <SafeAreaView style={[styles.wrapper, {}]} >
            ...
            <ScrollView
                ...
                style={{ flex: 1, backgroundColor: '#FFFFFF', paddingTop: Platform.OS === 'android' ? StatusBarManager.HEIGHT : 0, }}>
                <View style={styles.header}>
                    <View style={styles.headerLeft}>
                        <TouchableOpacity style={styles.imageWrapper}>
                            <Image style={styles.image} source={require('../../assets/Images/evergas-user-img.png')} />
                        </TouchableOpacity>
                        <View>
                ...
                <View style={styles.actionsWrapper}>
                    ...
                    <TouchableOpacity style={[styles.actions, { backgroundColor: '#38C076', }]}>
                        <View style={styles.actionIconWrapper}>
                            <Svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={12}
